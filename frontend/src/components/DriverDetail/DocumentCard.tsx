...
export const DocumentCard: React.FC<DocumentCardProps> = ({
  ...
  return (
    <div className="w-full p-[4px] bg-white shadow-[0px_1px_2px_rgba(0,0,0,0.05)] overflow-hidden rounded-[24px] outline outline-1 outline-[rgba(188,202,188,0.10)] -outline-offset-1 flex flex-col justify-start items-center gap-[4px] mb-[16px]">
      ...
      <div className="w-full h-[192px] max-w-[340px] relative bg-[#EFF6EC] rounded-[20px] flex justify-center items-center overflow-hidden">
        {documentImage && !documentImage.includes("unsplash.com") ? (
          <img
          ...
          <div className="text-[#3D4A3F] font-bold text-[14px]">
            {title}画像未提出
          </div>
        )}
      </div>
