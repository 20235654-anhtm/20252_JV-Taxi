...
export const ReviewsCard: React.FC<ReviewsCardProps> = ({
  ...
  if (totalReviews === 0) {
    return (
      <div className="w-full p-[24px] bg-white rounded-[32px] flex flex-col justify-center items-center gap-[12px] !mt-[50px] min-h-[150px]">
        <div className="text-[#171D17] text-[18px] font-[700] leading-[22.50px] break-words">評価</div>
        <div className="text-[#3D4A3F] text-[14px] font-bold text-center mt-[12px]">
          評価・レビューはまだありません
        </div>
      </div>
    );
