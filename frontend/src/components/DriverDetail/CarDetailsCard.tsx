...
import type { CarDetailsCardProps } from '../../types/DriverDetail';
  ...
  return (
    <div className="w-full bg-[#E9F0E6] rounded-[24px] pt-[24px] pb-[40px] px-[24px] flex flex-col justify-start items-start gap-[16px]">
      ...
      <div className="w-full p-[16px] bg-white rounded-[16px] flex flex-col justify-start items-start gap-[16px]">
        {carImage && !carImage.includes("unsplash.com") ? (
          <img
            src={carImage}
            alt="Car"
          ...
          <div className="w-full h-[128px] rounded-[12px] bg-[#EFF6EC] border border-[#BCCABC] flex items-center justify-center text-[#3D4A3F] font-bold text-[14px]">
            車両画像未登録
          </div>
        )}
